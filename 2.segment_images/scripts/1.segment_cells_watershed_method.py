...
# guassian filter to smooth the image
...
# for z in range(nuclei_labels.shape[0]):
#     # erode the nuclei mask to remove small artifacts
#     nuclei_labels[z] = skimage.morphology.erosion(
#         image=nuclei_labels[z],
#         footprint=skimage.morphology.disk(15), # 15 pixel radius disk
#     )
