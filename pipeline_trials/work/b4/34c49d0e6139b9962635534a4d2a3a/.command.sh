...
echo "Processing patient: NF0014, well_fov: C4-2, use_gpu: /home/lippincm/miniforge3/envs/"
bash run_area_shape_child.sh NF0014 C4-2 TRUE /home/lippincm/miniforge3/envs/
