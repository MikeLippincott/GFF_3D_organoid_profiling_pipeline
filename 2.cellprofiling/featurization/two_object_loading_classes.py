...
class ColocalizationFeaturization:
    ...
    def calculate_colocalization_features(self):
        ...
        self.features["colocalization"] = calculate_3D_colocalization(
            croppped_image_1=self.object_loader.image_object1,
            croppped_image_2=self.object_loader.image_object2,
            thr=15,
            fast_costes="Accurate",
        )
        logging.info(
            f"Calculated Colocalization features for {self.object_loader.compartment1} {self.object_loader.index1} and {self.object_loader.compartment2} {self.object_loader.index2}"
        )
